        ...
        <div className="contacto__grid">
          <div className="contacto__left">
            ...
            <div className="contacto__info">
              <a href="mailto:hola@ceomultimedios.com" className="contacto__item">
                <div className="contacto__item-icon">✉️</div>
                <div>
                  <span className="contacto__item-label">Email</span>
                  <span className="contacto__item-value">hola@ceomultimedios.com</span>
                </div>
              </a>
              <a href="https://wa.me/5493624000000" target="_blank" rel="noopener noreferrer" className="contacto__item">
                <div className="contacto__item-icon">💬</div>
                <div>
                  <span className="contacto__item-label">WhatsApp</span>
                  <span className="contacto__item-value">+54 9 362 400-0000</span>
                </div>
              </a>
            ...
            <div className="contacto__redes">
              ...
              <div className="contacto__redes-links">
                <a href="#" className="red-btn red-btn--ig" aria-label="Instagram">
                ...
                <a href="#" className="red-btn red-btn--fb" aria-label="Facebook">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                </a>
                <a href="#" className="red-btn red-btn--li" aria-label="LinkedIn">
