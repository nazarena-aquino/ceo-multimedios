      ...
      <div className="container">
        <div className="contacto__grid">
          ...
          <div className="contacto__left">
            ...
            {/* Redes visibles solo en desktop (≥900px) */}
            <div className="contacto__redes contacto__redes--desktop">
              <Redes />
            </div>
          </div>
          ...
          {/* Redes visibles solo en mobile (≤900px), abajo de todo */}
          <div className="contacto__redes--mobile">
            <Redes />
          </div>
